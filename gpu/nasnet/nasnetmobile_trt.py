...
def load_save_model(saved_model_dir = 'nasnetmobile_saved_model'):
...
saved_model_dir = 'nasnetmobile_saved_model' 
if load_model : 
...
def build_tensorrt_engine(precision, batch_size, dataset):
    ...
    converter = trt.TrtGraphConverterV2(input_saved_model_dir='nasnetmobile_saved_model',
    ...
    trt_compiled_model_dir = f'nasnetmobile_trt_saved_models/nasnetmobile_{precision}_{batch_size}'
