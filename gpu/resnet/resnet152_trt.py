...
def load_save_model(saved_model_dir = 'resnet152_saved_model'):
...
saved_model_dir = 'resnet152_saved_model' 
if load_model : 
...
def build_tensorrt_engine(precision, batch_size, dataset):
    ...
    converter = trt.TrtGraphConverterV2(input_saved_model_dir='resnet152_saved_model',
    ...
    trt_compiled_model_dir = f'resnet152_trt_saved_models/resnet152_{precision}_{batch_size}'
