...
def load_save_model(saved_model_dir = 'vgg19_saved_model'):
...
saved_model_dir = 'vgg19_saved_model' 
if load_model : 
...
def build_tensorrt_engine(precision, batch_size, dataset):
    ...
    converter = trt.TrtGraphConverterV2(input_saved_model_dir='vgg19_saved_model',
    ...
    trt_compiled_model_dir = f'vgg19_trt_saved_models/vgg19_{precision}_{batch_size}'
