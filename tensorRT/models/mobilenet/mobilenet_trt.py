...
def build_tensorrt_engine(precision, batch_size, dataset):
    ...
    converter = trt.TrtGraphConverterV2(input_saved_model_dir='mobilenet_saved_model',
    ...
    trt_compiled_model_dir = f'mobilenet_trt_saved_models/mobilenet_{precision}_{batch_size}'
