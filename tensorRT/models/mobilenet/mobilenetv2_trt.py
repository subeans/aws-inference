...
def load_save_model(saved_model_dir = 'mobilenet_v2_saved_model'):
...
def build_tensorrt_engine(precision, batch_size, dataset):
    ...
    converter = trt.TrtGraphConverterV2(input_saved_model_dir='mobilenet_v2_saved_model',
    ...
    trt_compiled_model_dir = f'mobilenet_v2_trt_saved_models/mobilenet_v2_{precision}_{batch_size}'
