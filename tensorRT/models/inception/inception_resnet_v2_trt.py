...
def build_tensorrt_engine(precision, batch_size, dataset):
    ...
    converter = trt.TrtGraphConverterV2(input_saved_model_dir='inception_resnet_v2_saved_model',
    ...
    trt_compiled_model_dir = f'inception_resnet_v2_trt_saved_models/inception_resnet_v2_{precision}_{batch_size}'
