...
def build_tensorrt_engine(precision, batch_size, dataset):
    ...
    converter = trt.TrtGraphConverterV2(input_saved_model_dir='vgg16_saved_model',
    ...
    trt_compiled_model_dir = f'vgg16_trt_saved_models/vgg16_{precision}_{batch_size}'
