...
def build_tensorrt_engine(precision, batch_size, dataset):
    ...
    converter = trt.TrtGraphConverterV2(input_saved_model_dir='nasnetlarge_saved_model',
    ...
    trt_compiled_model_dir = f'nasnetlarge_trt_saved_models/nasnetlarge_{precision}_{batch_size}'
