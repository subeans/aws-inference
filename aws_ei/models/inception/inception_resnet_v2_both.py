#ValueError: Cannot feed value of shape (1, 224, 224, 3) for Tensor 'serving_default_input_1:0', which has shape '(None, 299, 299, 3)'
...
temp = tf.zeros([8, 299, 299, 3])
_ = tf.keras.applications.inception_resnet_v2.preprocess_input(temp)
...
def load_save_model(saved_model_dir = 'inception_resnet_v2_saved_model'):
...
saved_model_dir = 'inception_resnet_v2_saved_model' 
if load_model : 
    load_save_model(saved_model_dir)
    print("_____inception_resnet_v2_______")
