...
_ = tf.keras.applications.inception_v3.preprocess_input(temp)
...
def load_save_model(saved_model_dir = 'inception_v3_saved_model'):
...
saved_model_dir = 'inception_v3_saved_model' 
if load_model : 
