#ValueError: Cannot feed value of shape (1, 224, 224, 3) for Tensor 'serving_default_input_1:0', which has shape '(None, 331, 331, 3)'
...
temp = tf.zeros([8, 331, 331, 3])
_ = tf.keras.applications.nasnet.preprocess_input(temp)
...
def load_save_model(saved_model_dir = 'nasnetlarge_saved_model'):
...
def val_preprocessing(record):
    ...
    image = tf.image.resize_with_crop_or_pad(image, 331, 331)
...
saved_model_dir = 'nasnetlarge_saved_model' 
if load_model : 
